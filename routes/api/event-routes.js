...
router.get('/calendars/:calendarId/events/:arrangementId', checkTokenMiddleware, getAllUsersInvitedToArrangement);       //Отримати всіх користувачів, які запрошені на arrangement
